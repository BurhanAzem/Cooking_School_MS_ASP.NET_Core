...
namespace Cooking_School_ASP.NET.Repository
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IGenericRepository<SubmitedFile> _submitedFiles;
        ...
        public IGenericRepository<SubmitedFile> SubmitedFiles => _submitedFiles ??= new GenericRepository<SubmitedFile>(_dBContext);
